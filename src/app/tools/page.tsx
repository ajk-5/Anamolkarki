...
import styles from "../api/games-tools/src/app/tools/Tools.module.css";

export const metadata: Metadata = {
  title: "Free Online Tools | PDF Signer, Image Compressor, QR, World Clock",
  description:
    "Use fast, privacy-friendly browser tools: sign PDFs, compress and convert images (AVIF/WebP/JPEG/PNG), generate or scan QR codes, check world times, and practice typing.",
  keywords: [
    "online tools",
    "pdf signer",
    "image compressor",
...
const tools = [
  ...
  {
    href: "/tools/facture",
    label: "Générateur de facture (PDF)",
    title:
      "Générateur de facture PDF - modèle français, numéros horodatés, export imprimable.",
    icon: icons.pdf,
  },
  {
        ...
        <ul className={styles.list}>
          {tools.map((tool) => (
            <li className={styles.item} key={tool.href}>
              <Link href={tool.href} title={tool.title} className={styles.blockLink}>
