  ...
  return (
    <div className="relative min-h-screen overflow-x-hidden bg-slate-950 text-slate-100">
      ...
      <div className="relative z-10 mx-auto flex max-w-6xl flex-col gap-10 px-4 pb-16 pt-14 lg:px-8">
        <section className="relative overflow-hidden rounded-3xl border border-slate-800/60 bg-gradient-to-br from-slate-900/70 via-slate-900/40 to-slate-950 p-6 shadow-2xl ring-1 ring-slate-800/40">
          ...
          <div className="relative z-10 flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            <div className="space-y-3">
              <div className="inline-flex items-center gap-2 rounded-full border border-fuchsia-400/50 bg-white/10 px-3 py-1 text-xs uppercase tracking-[0.14em] text-fuchsia-200">
                Galerie barman
              ...
              <div className="flex flex-wrap gap-3">
                <Link href="/Bar" className="rounded-full border border-slate-700 px-4 py-2 text-xs font-semibold text-slate-100 transition hover:-translate-y-0.5 hover:border-cyan-400/60">
                  Retour au portfolio barman
                </Link>
                <Link href="/contact" className="rounded-full border border-teal-500/40 bg-white/5 px-4 py-2 text-xs font-semibold text-teal-100 transition hover:-translate-y-0.5">
                ...
                <Link
                  ...
                  className="rounded-full border border-slate-700 bg-white/5 px-4 py-2 text-xs font-semibold text-slate-100 transition hover:-translate-y-0.5 hover:border-cyan-400/60"
                >
                  Télécharger le CV barman
                </Link>
              </div>
            </div>
            <div className="flex gap-2 rounded-full border border-slate-800 bg-slate-900/60 p-1 text-sm shadow-lg">
              {(["methods", "materials", "glasses"] as Category[]).map((tab) => (
                <button
                  key={tab}
                  onClick={() => setActiveTab(tab)}
                  className={`rounded-full px-3 py-1.5 transition ${
                    activeTab === tab ? "bg-white/10 text-white shadow-[0_10px_30px_rgba(34,211,238,0.15)]" : "text-slate-400 hover:text-slate-200"
                  }`}
                >
        ...
        <section className="rounded-3xl border border-slate-800/70 bg-slate-900/50 p-4 shadow-xl backdrop-blur">
